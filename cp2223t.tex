...
\\
\>[B]{}\Varid{psimulateGroupStage'}\mathrel{=}\Varid{trim'}\comp {}\<[33]%
\>[33]{}\map \;(\Varid{pgroupWinners}\;\Varid{pgsCriteria}){}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{trim'}\mathrel{=}\Varid{top}\;\mathrm{5}\comp \Varid{sequence}\comp \map \;(\Varid{top}\;\mathrm{5}\comp \Varid{filterP}\comp \Varid{norm})\;{}\<[56]%
\>[56]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{filterP}\;(\Conid{D}\;\Varid{x})\mathrel{=}\Conid{D}\;[\mskip1.5mu (\Varid{a},\Varid{p})\mid (\Varid{a},\Varid{p})\leftarrow \Varid{x},\Varid{p}\mathbin{>}\mathrm{0.0001}\mskip1.5mu]{}\<[E]%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{loop}\;\Varid{a}\;\Varid{b}\;\Varid{c}\mathrel{=}\conj{\conj{\Varid{add}\comp ((\Varid{add}\comp ((\Varid{a}\mathbin{*})\times(\Varid{b}\mathbin{*})))\times(\Varid{c}\mathbin{*}))}{\p1\comp \p1}}{\p2\comp \p1}{}\<[E]%
\\
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{splitIndent}\mathbin{::}\Conid{Int}\to [\mskip1.5mu \Conid{String}\mskip1.5mu]\to [\mskip1.5mu [\mskip1.5mu \Conid{String}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{splitIndent}\;\Varid{x}\;\Varid{strs}\mathrel{=}\Varid{tail}\;(\Varid{aux}\;\Varid{strs}\;[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{aux}\mathbin{::}[\mskip1.5mu \Conid{String}\mskip1.5mu]\to [\mskip1.5mu \Conid{String}\mskip1.5mu]\to [\mskip1.5mu [\mskip1.5mu \Conid{String}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{aux}\;[\mskip1.5mu \mskip1.5mu]\;\Varid{acc}\mathrel{=}[\mskip1.5mu \Varid{acc}\mskip1.5mu]{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{aux}\;(\Varid{h}\mathbin{:}\Varid{t})\;\Varid{acc}\mid \Varid{head}\;\Varid{unindent}\mathbin{!=}\text{\ttfamily '~'}\mathrel{=}\Varid{acc}\mathbin{:}(\Varid{aux}\;\Varid{t}\;[\mskip1.5mu \Varid{unindent}\mskip1.5mu]){}\<[E]%
\\
\>[9]{}\hsindent{14}{}\<[23]%
\>[23]{}\mid \Varid{otherwise}{}\<[46]%
\>[46]{}\mathrel{=}\Varid{aux}\;\Varid{t}\;(\Varid{acc}\mathbin{+\!\!\!+}[\mskip1.5mu \Varid{unindent}\mskip1.5mu]){}\<[E]%
\\
\>[9]{}\hsindent{4}{}\<[13]%
\>[13]{}\mathbf{where}{}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{unindent}\mathrel{=}\Varid{drop}\;\Varid{x}\;\Varid{h}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{gene}\mathrel{=}(\Varid{id}+(\Varid{id}\times(\Varid{splitIndent}\;\mathrm{4})))\comp \Varid{out}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{foo}\mathbin{::}[\mskip1.5mu \Conid{String}\mskip1.5mu]\to ([\mskip1.5mu \Conid{String}\mskip1.5mu],[\mskip1.5mu \Conid{String}\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{foo}\mathrel{=}\conj{\Varid{takeWhile}\;(\lambda \Varid{x}\to \Varid{x}\mathbin{!!}\mathrm{4}\equiv \text{\ttfamily '~'})}{\Varid{dropWhile}\;(\lambda \Varid{x}\to \Varid{x}\mathbin{!!}\mathrm{4}\equiv \text{\ttfamily '~'})}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{baz}\mathrel{=}\anaList{(\Varid{id}+\conj{(\map \;(\Varid{drop}\;\mathrm{4}))\comp \Varid{cons}\comp (\Varid{id}\times\p1)}{\p2\comp \p2})\comp (\Varid{id}+(\Varid{id}\times\Varid{foo}))\comp \Varid{outList}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{attachAll}\mathbin{::}\Varid{a}\to [\mskip1.5mu [\mskip1.5mu \Varid{a}\mskip1.5mu]\mskip1.5mu]\to [\mskip1.5mu [\mskip1.5mu \Varid{a}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{attachAll}\;\Varid{a}\mathrel{=}\map \;((\mathbin{:})\;\Varid{a}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{post}\mathbin{::}\Conid{Exp}\;\Conid{String}\;\Conid{String}\to [\mskip1.5mu [\mskip1.5mu \Conid{String}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{post}\mathrel{=}\llparenthesis\, \alt{\Varid{singl}}{\Varid{cons}}\comp (\Varid{singl}+(\conj{\Varid{singl}\comp \p1}{\uncurry{\Varid{attachAll}}}\comp (\Varid{id}\times\Varid{concat})))\,\rrparenthesis_\textit{\tiny Exp}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\newline
\begin{minipage}[t]{0.6\textwidth}
...
\begin{tikzcd}
  ...
  \arrow["{post = (\ensuremath{\Varid{gene}})}"', from=1-1, to=5-1]
...
\\[\blanklineskip]%
\>[B]{}\Varid{shrink}\mathbin{::}\Conid{Square}\to \Conid{Square}{}\<[E]%
\\
\>[B]{}\Varid{shrink}\;((\Varid{x},\Varid{y}),\Varid{s})\mathrel{=}\mathbf{let}\;\Varid{ns}\mathrel{=}\Varid{s}\mathbin{/}\mathrm{3}\;\mathbf{in}\;((\Varid{x}\mathbin{+}\Varid{ns},\Varid{y}\mathbin{+}\Varid{ns}),\Varid{ns}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{divide}\mathbin{::}\Conid{Square}\to [\mskip1.5mu \Conid{Square}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{divide}\;((\Varid{x},\Varid{y}),\Varid{s})\mathrel{=}[\mskip1.5mu \Varid{a},\Varid{b},\Varid{c},\Varid{d},\Varid{e},\Varid{f},\Varid{g},\Varid{h}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{ns}\mathrel{=}\Varid{s}\mathbin{/}\mathrm{3}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{x1}\mathrel{=}\Varid{x}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{x2}\mathrel{=}\Varid{x}\mathbin{+}\Varid{ns}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{x3}\mathrel{=}\Varid{x}\mathbin{+}\Varid{s}\mathbin{-}\Varid{ns}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{y1}\mathrel{=}\Varid{y}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{y2}\mathrel{=}\Varid{y}\mathbin{+}\Varid{ns}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{y3}\mathrel{=}\Varid{y}\mathbin{+}\Varid{s}\mathbin{-}\Varid{ns}{}\<[E]%
\\[\blanklineskip]%
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{a}{}\<[12]%
\>[12]{}\mathrel{=}((\Varid{x1},\Varid{y1}),\Varid{ns}){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{b}{}\<[12]%
\>[12]{}\mathrel{=}((\Varid{x2},\Varid{y1}),\Varid{ns}){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{c}{}\<[12]%
\>[12]{}\mathrel{=}((\Varid{x3},\Varid{y1}),\Varid{ns}){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{d}{}\<[12]%
\>[12]{}\mathrel{=}((\Varid{x1},\Varid{y2}),\Varid{ns}){}\<[E]%
\\[\blanklineskip]%
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{e}{}\<[12]%
\>[12]{}\mathrel{=}((\Varid{x3},\Varid{y2}),\Varid{ns}){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{f}{}\<[12]%
\>[12]{}\mathrel{=}((\Varid{x1},\Varid{y3}),\Varid{ns}){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{g}{}\<[12]%
\>[12]{}\mathrel{=}((\Varid{x2},\Varid{y3}),\Varid{ns}){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{h}{}\<[12]%
\>[12]{}\mathrel{=}((\Varid{x3},\Varid{y3}),\Varid{ns}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{gsq}\;(\Varid{sq},\mathrm{0})\mathrel{=}(\Varid{shrink}\;\Varid{sq},[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{gsq}\;(\Varid{sq},\Varid{n})\mathrel{=}(\Varid{shrink}\;\Varid{sq},\Varid{zip}\;(\Varid{divide}\;\Varid{sq})\;(\Varid{replicate}\;\mathrm{8}\;(\Varid{n}\mathbin{-}\mathrm{1}))){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{carpets}\mathrel{=}\anaList{(\Varid{id}+\conj{\overline{\Varid{sierpinski}}\;((\mathrm{0},\mathrm{0}),\mathrm{32})}{\Varid{id}})\comp \Varid{outNat}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{present}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Varid{return}\;[\mskip1.5mu ()\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{present}\;(\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}\mathbf{do}{}\<[E]%
\\
\>[B]{}\hsindent{21}{}\<[21]%
\>[21]{}\Varid{present}\;\Varid{t}{}\<[E]%
\\
\>[B]{}\hsindent{21}{}\<[21]%
\>[21]{}\Varid{drawSq}\;\Varid{h}{}\<[E]%
\\
\>[B]{}\hsindent{21}{}\<[21]%
\>[21]{}\Varid{await}{}\<[E]%
\\
\>[B]{}\hsindent{21}{}\<[21]%
\>[21]{}\Varid{return}\;[\mskip1.5mu ()\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{cgene}\mathbin{::}(\Conid{Num}\;\Varid{b},\Conid{Eq}\;\Varid{a})\Rightarrow ()+((\Varid{a},\Varid{b}),[\mskip1.5mu (\Varid{a},\Varid{b})\mskip1.5mu])\to [\mskip1.5mu (\Varid{a},\Varid{b})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{cgene}\mathrel{=}\alt{\Varid{nil}}{\Varid{addOrSum}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{addOrSum}\;(\Varid{x},[\mskip1.5mu \mskip1.5mu])\mathrel{=}[\mskip1.5mu \Varid{x}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{addOrSum}\;((\Varid{a},\Varid{b}),((\Varid{c},\Varid{d})\mathbin{:}\Varid{t}))\mid \Varid{a}\equiv \Varid{c}{}\<[40]%
\>[40]{}\mathrel{=}(\Varid{a},\Varid{b}\mathbin{+}\Varid{d})\mathbin{:}\Varid{t}{}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mid \Varid{otherwise}\mathrel{=}(\Varid{c},\Varid{d})\mathbin{:}\Varid{addOrSum}\;((\Varid{a},\Varid{b}),\Varid{t}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Geração dos jogos da fase de grupos:
\begin{hscode}\SaveRestoreHook
...
\column{33}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{pairup}\;\Varid{xs}\mathrel{=}[\mskip1.5mu \Varid{x}\mapsto\Varid{y}\mid (\Varid{x}\mathbin{:}\Varid{ys})\leftarrow \Varid{tails}\;\Varid{xs},\Varid{y}\leftarrow \Varid{ys}\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{matchResult}\;\Varid{criteria}\;(\Varid{a},\Varid{b})\mathrel{=}\mathbf{let}\;\Varid{winner}\mathrel{=}\Varid{criteria}\;(\Varid{a},\Varid{b})\;\mathbf{in}{}\<[E]%
\\
\>[B]{}\hsindent{33}{}\<[33]%
\>[33]{}\Varid{givePoints}\;(\Varid{a},\Varid{b})\;\Varid{winner}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{givePoints}\mathbin{::}\Conid{Match}\to \Conid{Maybe}\;\Conid{Team}\to [\mskip1.5mu (\Conid{Team},\Conid{Int})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{givePoints}\;(\Varid{a},\Varid{b})\;\Conid{Nothing}\mathrel{=}[\mskip1.5mu ((\Varid{a},\mathrm{1})),(\Varid{b},\mathrm{1})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{givePoints}\;(\Varid{a},\Varid{b})\;(\Conid{Just}\;\Varid{x})\mid \Varid{a}\equiv \Varid{x}\mathrel{=}[\mskip1.5mu (\Varid{a},\mathrm{3}),(\Varid{b},\mathrm{0})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{27}{}\<[27]%
\>[27]{}\mid \Varid{b}\equiv \Varid{x}\mathrel{=}[\mskip1.5mu (\Varid{a},\mathrm{0}),(\Varid{b},\mathrm{3})\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{glt}\mathbin{::}[\mskip1.5mu \Varid{a}\mskip1.5mu]\to \Varid{a}+([\mskip1.5mu \Varid{a}\mskip1.5mu],[\mskip1.5mu \Varid{a}\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{glt}\;[\mskip1.5mu \Varid{a}\mskip1.5mu]\mathrel{=}i_1\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{glt}\;\Varid{xs}{}\<[9]%
\>[9]{}\mathrel{=}i_2\;(\Varid{a},\Varid{b}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{half}\mathrel{=}\length \;\Varid{xs}\div \mathrm{2}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{a}\mathrel{=}\Varid{take}\;\Varid{half}\;\Varid{xs}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{b}\mathrel{=}\Varid{drop}\;\Varid{half}\;\Varid{xs}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\subsubsection*{Versão probabilística}
\begin{hscode}\SaveRestoreHook
...
\\[\blanklineskip]%
\>[B]{}\Varid{pgroupWinners}\;\Varid{crit}\mathrel{=}(\Varid{return}\comp (\Varid{best}\;\mathrm{2}\comp \Varid{consolidate}\comp \Varid{concat}))\kcomp(\Varid{mmap}\;(\Varid{pmatchResult}\;\Varid{crit})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{pgroupWinners'}\;\Varid{criteria}\;\Varid{matches}\mathrel{=}\mathbf{do}{}\<[E]%
\\
\>[B]{}\hsindent{36}{}\<[36]%
\>[36]{}\Varid{x}\leftarrow \Varid{mmap}\;(\Varid{pmatchResult}\;\Varid{criteria})\;\Varid{matches}{}\<[E]%
\\
\>[B]{}\hsindent{36}{}\<[36]%
\>[36]{}\Varid{return}\;((\Varid{best}\;\mathrm{2}\comp \Varid{consolidate}\comp \Varid{concat})\;\Varid{x}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{pmatchResult}\;\Varid{criteria}\;(\Varid{a},\Varid{b})\mathrel{=}\mathbf{do}{}\<[E]%
\\
\>[B]{}\hsindent{29}{}\<[29]%
\>[29]{}\Varid{winner}\leftarrow \Varid{criteria}\;(\Varid{a},\Varid{b}){}\<[E]%
\\
\>[B]{}\hsindent{29}{}\<[29]%
\>[29]{}\Varid{return}\;(\Varid{givePoints}\;(\Varid{a},\Varid{b})\;\Varid{winner}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
